...
var (
	...
	ErrNotInitialized = errors.New("usuario controller not initialized")
)

// UseUsuario agrupa todas as camadas do subdomínio.
type UseUsuario struct {
